...
function generateHtmlDate() {
    return /*html*/`
        ...
        <div class="dueDate-div">
            <div>
                <input type="date" class="inputfield" id="date" placeholder="yyyy-mm-dd" value="" min="2024-01-01" max="2030-12-31" onfocus="inputfieldFocus('date')" oninput="inputfieldFocus('date')" required > <!-- pattern="\d{2}/\m{2}/\y{4}" -->
