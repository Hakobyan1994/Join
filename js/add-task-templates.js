...
function generateHtmlDate() {
    return /*html*/`
        ...
        <div class="dueDate-div">
            <div>
                <input date="" data-date="" data-date-format="DD MMMM YYYY" value="" type="date" class="inputfield" id="date" placeholder="yyyy-mm-dd" value="" min="2024-02-24" max="2030-12-31" onfocus="inputfieldFocus('date')" oninput="inputfieldFocus('date')" required > <!-- pattern="\d{2}/\m{2}/\y{4}" -->
